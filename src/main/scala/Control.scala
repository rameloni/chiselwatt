...
object Control {
  ...
  object Unit extends ChiselEnum {
    val U_ADD  = Value(0.U(4.W))
    val U_LOG  = Value(1.U(4.W))
    val U_ROT  = Value(2.U(4.W))
    val U_MUL  = Value(3.U(4.W))
    val U_DIV  = Value(4.U(4.W))
    val U_LDST = Value(5.U(4.W))
    val U_BR   = Value(6.U(4.W))
    val U_CR   = Value(7.U(4.W))
    val U_ZER  = Value(8.U(4.W))
    val U_POP  = Value(9.U(4.W))
    val U_SPR  = Value(10.U(4.W))
    val U_ILL  = Value(11.U(4.W))
    val U_NONE = Value(12.U(4.W))
  }
...
//  val BR_COND   = 1.U(2.W)
  ...
  val default =
                     List(U_ILL,  InternalOps.DC,         DC,            DC,             DC,    ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,   DC,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC)
  ...
  val map = Array(
    ...
    ADDIC         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_RT,   CA_0,   Y,       DC,  DC,   CMP_RC_0,  DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDIC_DOT     -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_RT,   CA_0,   Y,       DC,  DC,   CMP_RC_1,  DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDI          -> List(U_ADD,  InternalOps.DC,         RA_RA_OR_ZERO, RB_CONST_SI,    DC,    ROUT_RT,   CA_0,   N,       DC,  DC,   CMP_RC_0,  DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDIS         -> List(U_ADD,  InternalOps.DC,         RA_RA_OR_ZERO, RB_CONST_SI_HI, DC,    ROUT_RT,   CA_0,   N,       DC,  DC,   CMP_RC_0,  DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBFIC        -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_RT,   CA_1,   Y,       DC,  DC,   CMP_RC_0,  DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADD           -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_0,   N,       DC,  DC,   CMP_RC_RC, DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDC          -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_0,   Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDE          -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDME         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_M1,    DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ADDZE         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_ZERO,  DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    N,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBF          -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_1,   N,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBFC         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_1,   Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBFE         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBFME        -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_M1,    DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SUBFZE        -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_ZERO,  DC,    ROUT_RT,   CA_CA,  Y,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    NEG           -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_ZERO,  DC,    ROUT_RT,   CA_1,   N,       DC,  DC,   CMP_RC_RC, DC,     DC,    Y,       N,        DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ...
    RLWIMI        -> List(U_ROT,  InternalOps.DC,         RA_RA,         RB_CONST_SH32,  RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       N,         Y,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLWINM        -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH32,  RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       N,         Y,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLWNM         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       N,         Y,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDIC         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH,    RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         Y,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDICL        -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH,    RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         Y,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDICR        -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH,    RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         N,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDIMI        -> List(U_ROT,  InternalOps.DC,         RA_RA,         RB_CONST_SH,    RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         Y,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDCL         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         Y,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    RLDCR         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         N,        Y,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SLD           -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       N,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SLW           -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       N,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRAD          -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     Y,       DC,  DC,   CMP_RC_RC, N,      Y,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRADI         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH,    RS_RS, ROUT_RA,   DC,     Y,       DC,  DC,   CMP_RC_RC, N,      Y,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRAW          -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     Y,       DC,  DC,   CMP_RC_RC, Y,      Y,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRAWI         -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_CONST_SH32,  RS_RS, ROUT_RA,   DC,     Y,       DC,  DC,   CMP_RC_RC, Y,      Y,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRD           -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    SRW           -> List(U_ROT,  InternalOps.DC,         RA_ZERO,       RB_RB,          RS_RS, ROUT_RA,   DC,     N,       DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       Y,         N,        N,         DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ...
    MULLI         -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_0,  N,      Y,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         N,   DC,      DC,        DC,         DC),
    MULHD         -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, N,      Y,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         Y,   DC,      DC,        DC,         DC),
    MULHDU        -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, N,      N,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         Y,   DC,      DC,        DC,         DC),
    MULHW         -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, Y,      Y,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         Y,   DC,      DC,        DC,         DC),
    MULHWU        -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, Y,      N,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         Y,   DC,      DC,        DC,         DC),
    MULLD         -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, N,      Y,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         N,   DC,      DC,        DC,         DC),
    MULLW         -> List(U_MUL,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_RC, Y,      Y,     DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         N,   DC,      DC,        DC,         DC),
    ...
    SYNC          -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ISYNC         -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    DCBF          -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    DCBST         -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    DCBT          -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    DCBTST        -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ICBI          -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ICBT          -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CNTLZD        -> List(U_ZER,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_RC, N,      DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      N,         DC,         DC),
    CNTLZW        -> List(U_ZER,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_RC, Y,      DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      N,         DC,         DC),
    CNTTZD        -> List(U_ZER,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_RC, N,      DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      Y,         DC,         DC),
    CNTTZW        -> List(U_ZER,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_RC, Y,      DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      Y,         DC,         DC),
    POPCNTB       -> List(U_POP,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        LEN_1B, DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    POPCNTW       -> List(U_POP,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        LEN_4B, DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    POPCNTD       -> List(U_POP,  InternalOps.DC,         DC,            DC,             RS_RS, ROUT_RA,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        LEN_8B, DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPDI         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   N,      Y,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPWI         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_SI,    DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   Y,      Y,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPD          -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   N,      Y,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPW          -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   Y,      Y,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPLDI        -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_UI,    DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   N,      N,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPLWI        -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_CONST_UI,    DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   Y,      N,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPLD         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   N,      N,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    CMPLW         -> List(U_ADD,  InternalOps.DC,         RA_RA,         RB_RB,          DC,    ROUT_NONE, CA_1,   DC,      DC,  Y,    CMP_CMP,   Y,      N,     Y,       DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
    ...
    TDI           -> List(U_NONE, InternalOps.DC,         DC,            DC,             DC,    DC,        DC,     DC,      DC,  DC,   DC,        DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC)
  )
}
